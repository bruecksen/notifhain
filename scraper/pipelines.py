...
class EventDetailsPipeline(DjangoPipeline):
    def process_item(self, event_details_item, spider):
        ...
        event.has_timetable = event_details_item["has_timetable"]
    ...
    def close_spider(self, spider):
        if spider.send_email:
            ...
            for event in events:
                logger.info("send_timetable_email: " + event.event_details.name)
